...
const Alerts = () => {
  return (
    <div className="login-container"> {/* This ensures Lato is applied from your CSS */}
        ...
        <div className="flex flex-col gap-7.5">
          ...
          <div className="flex w-full border-l-6 border-warning bg-warning bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
            ...
            <div className="w-full">
              ...
              <p className="leading-relaxed text-[#D0915C] font-medium">
          ...
          <div className="flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
            ...
            <div className="w-full">
              ...
              <p className="text-base leading-relaxed text-body font-medium">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry.
              </p>
            </div>
          </div>
          ...
          <div className="flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
            <div className="mr-5 flex h-9 w-full max-w-[36px] items-center justify-center rounded-lg bg-[#F87171]">
              <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.4917 7.65579L11.106 12.2645C11.2545 12.4128 11.4715 12.5 11.6738 12.5C11.8762 12.5 12.0931 12.4128 12.2416 12.2645C12.5621 11.9445 12.5623 11.4317 12.2423 11.1114L7.64539 6.50351L12.2589 1.91221L6.49234 5.34931L1.89459 0.740581L1.32616 12.5L6.4917 7.65579Z" fill="#ffffff" stroke="#ffffff" />
              </svg>
            </div>
            <div className="w-full">
              <h5 className="mb-3 text-lg font-bold text-[#B45454]">
                There were errors with your submission
              </h5>
              <ul>
                <li className="leading-relaxed text-[#CD5D5D] font-medium">
